...
export default function WalletPage() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {SUPPORTED_CRYPTOS.map((crypto) => (
          <div key={crypto.symbol} className="bg-crypto-secondary text-gray-300 p-6 rounded-lg shadow">
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 rounded-l-md border-r-0 border-gray-300 bg-crypto-primary text-gray-300"
